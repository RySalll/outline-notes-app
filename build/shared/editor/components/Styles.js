...
exports.pulse = exports.fadeIn = exports.default = void 0;
...
const fadeIn = exports.fadeIn = (0, _styledComponents.keyframes)`
  from { opacity: 0; }
  to { opacity: 1; }
`;
const pulse = exports.pulse = (0, _styledComponents.keyframes)`
...
`;
const codeMarkCursor = () => (0, _styledComponents.css)`
...
`;
const mathStyle = props => (0, _styledComponents.css)`
...
`;
const codeBlockStyle = props => (0, _styledComponents.css)`
  .token.comment,
  .token.prolog,
  .token.doctype,
  .token.cdata {
...
`;
const findAndReplaceStyle = () => (0, _styledComponents.css)`
...
`;
const emailStyle = props => (0, _styledComponents.css)`
  .attachment {
    display: block;
...
`;
const style = props => (0, _styledComponents.css)`
...
.${_EditorStyleHelper.EditorStyleHelper.tableFullWidth} {
  transform: translateX(calc(50% + ${_EditorStyleHelper.EditorStyleHelper.padding}px + var(--container-width) * -0.5));

  .${_EditorStyleHelper.EditorStyleHelper.tableScrollable},
  table {
    width: calc(var(--container-width) - ${_EditorStyleHelper.EditorStyleHelper.padding * 2}px);
  }

  &.${_EditorStyleHelper.EditorStyleHelper.tableShadowRight}::after {
    left: calc(var(--container-width) - ${_EditorStyleHelper.EditorStyleHelper.padding * 3}px);
  }
}
...
.${_EditorStyleHelper.EditorStyleHelper.comment} {
...
.notice-block {
  display: flex;
  align-items: center;
  background: ${(0, _polished.transparentize)(0.9, props.theme.noticeInfoBackground)};
...
.notice-block.tip {
  background: ${(0, _polished.transparentize)(0.9, props.theme.noticeTipBackground)};
...
.notice-block.warning {
  background: ${(0, _polished.transparentize)(0.9, props.theme.noticeWarningBackground)};
...
.notice-block.success {
  background: ${(0, _polished.transparentize)(0.9, props.theme.noticeSuccessBackground)};
...
p a {
  color: ${props.theme.text};
  text-decoration: underline;
  text-decoration-color: ${(0, _polished.lighten)(0.5, props.theme.text)};
...
.code-block[data-language=mermaidjs] {
  ...
  ${!props.staticHTML && (0, _styledComponents.css)`
      pre {
...
table {
  ...
  * {
  ...
  th {
    background: ${(0, _polished.transparentize)(0.75, props.theme.divider)};
    color: ${props.theme.textSecondary};
    font-weight: 500;
  }
  ...
  .${_EditorStyleHelper.EditorStyleHelper.tableAddRow},
  .${_EditorStyleHelper.EditorStyleHelper.tableAddColumn},
  .${_EditorStyleHelper.EditorStyleHelper.tableGrip},
  .${_EditorStyleHelper.EditorStyleHelper.tableGripColumn},
  .${_EditorStyleHelper.EditorStyleHelper.tableGripRow} {
    @media print {
      display: none;
    }
  }
  ...
  .${_EditorStyleHelper.EditorStyleHelper.tableAddRow} {
    ...
    &:hover {
      width: calc(var(--table-width) - ${_EditorStyleHelper.EditorStyleHelper.padding * 1.5}px);
    }
  ...
  .${_EditorStyleHelper.EditorStyleHelper.tableAddColumn} {
    ...
    &:hover {
      height: calc(var(--table-height) - ${_EditorStyleHelper.EditorStyleHelper.padding}px + 6px);
    }
...
.${_EditorStyleHelper.EditorStyleHelper.table} {
  position: relative;
}

.${_EditorStyleHelper.EditorStyleHelper.tableScrollable} {
  position: relative;
  margin: -1em ${-_EditorStyleHelper.EditorStyleHelper.padding}px -0.5em;
  ...
  padding-top: 1em;
  padding-bottom: .5em;
  padding-left: ${_EditorStyleHelper.EditorStyleHelper.padding}px;
  padding-right: ${_EditorStyleHelper.EditorStyleHelper.padding}px;
...
.${_EditorStyleHelper.EditorStyleHelper.tableShadowLeft}::before,
.${_EditorStyleHelper.EditorStyleHelper.tableShadowRight}::after {
  content: "";
  position: absolute;
  top: 1px;
...
.${_EditorStyleHelper.EditorStyleHelper.tableShadowLeft}::before {
  left: -${_EditorStyleHelper.EditorStyleHelper.padding}px;
  right: auto;
  box-shadow: 16px 0 16px -16px inset rgba(0, 0, 0, ${props.theme.isDark ? 1 : 0.25});
  border-left: ${_EditorStyleHelper.EditorStyleHelper.padding}px solid ${props.theme.background};
}

.${_EditorStyleHelper.EditorStyleHelper.tableShadowRight}::after {
  right: -${_EditorStyleHelper.EditorStyleHelper.padding}px;
  left: auto;
  box-shadow: -16px 0 16px -16px inset rgba(0, 0, 0, ${props.theme.isDark ? 1 : 0.25});
  border-right: ${_EditorStyleHelper.EditorStyleHelper.padding}px solid ${props.theme.background};
}
